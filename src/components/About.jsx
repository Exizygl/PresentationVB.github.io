...
const About = () => {
  return (
    <>
      ...
      >
        Bonjour, je suis à la recherche d'une entreprise pour gagner de l'experience suite a
        l'obtention de mon titre de developpeur web/ web mobile, je suis sérieux et motivé. J'ai les capacités
